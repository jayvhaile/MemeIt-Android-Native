...
class DrawableBadge private constructor(val context: Context,
    ...
    class Builder(private val context: Context) {
        ...
        private fun createBitmapFromVectorDrawable(vectorDrawable: VectorDrawableCompat): Bitmap {
        ...
        fun drawableResId(@DrawableRes drawableRes: Int) = apply {
            ...
            if (bitmap == null) {
                val d = ResourcesCompat.getDrawable(context.resources, drawableRes, null)?.current
                if (d is BitmapDrawable) {
                    bitmap = d.bitmap
                }
                if (d is VectorDrawableCompat) {
